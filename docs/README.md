...
- **[Roles and Personas](./octoacme-roles-and-personas.md)** — Detailed definitions of Developer, Product Manager, and Project Manager responsibilities, goals, and communication patterns
...
- **New team members**: Start with the Project Management Overview, then explore Roles and Personas to understand your responsibilities
- **Project kickoffs**: Review the Project Initiation and Project Planning guides to set up your project correctly
